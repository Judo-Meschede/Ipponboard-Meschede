...
ECHO             VALUE "FileDescription", "Ipponboard-Meschede">>%RC_FILE%
ECHO             VALUE "FileVersion", "%VER1%.%VER2%.%VER3%.%VER4%">>%RC_FILE%
ECHO             VALUE "InternalName", "Ipponboard-Meschede.exe">>%RC_FILE%
ECHO             VALUE "LegalCopyright", "Copyright (C) 2010-%DATE:~-4% Florian M�cke">>%RC_FILE%
ECHO             VALUE "OriginalFilename", "Ipponboard-Meschede.exe">>%RC_FILE%
ECHO             VALUE "ProductName", "Ipponboard-Meschede">>%RC_FILE%
if "%TAG%"=="" (
