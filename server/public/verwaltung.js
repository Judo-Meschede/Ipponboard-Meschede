...
function renderMultiModal(){
 ...
 $('#multiList input[type="checkbox"]').forEach(cb=>cb.onchange=()=>{cb.checked?multiSelected.add(cb.value):multiSelected.delete(cb.value);updateMultiCount()});
 updateMultiCount();
}
